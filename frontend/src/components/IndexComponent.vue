<template>
  <div>
    <header class="header">
      ...
      <nav>
        <ul>
          ...
          <li><router-link to="/groups">群组</router-link></li>
    ...
    <section class="section">
      ...
      <router-link to="/friends" class="more-btn">查看更多</router-link>
    </section>
    <section class="section">
      <h2>举办的活动</h2>
      <div class="card">
        <div class="card-content">
          ...
          <p>时间：2024年10月20日</p>
          <p>地点：图书馆</p>
          <p>简介：一场为期24小时的编程挑战赛。</p>
        </div>
      </div>
      <router-link to="/activities" class="more-btn">查看所有活动</router-link>
    </section>
    <section class="section">
      <h2>论坛</h2>
      <div class="card">
        <div class="card-content">
          <h3>最新帖子</h3>
          <p>用户A：大家好，有没有人一起组队参加编程马拉松？</p>
          <p>用户B：我有兴趣，怎么联系？</p>
        </div>
      </div>
      <router-link to="/forum" class="more-btn">进入论坛</router-link>
    </section>
    <section class="section">
      <h2>单对单聊天</h2>
      <div class="card">
        <div class="card-content">
          <h3>聊天示例</h3>
          <p>用户A：你好！</p>
          <p>用户B：你好，有什么可以帮忙的吗？</p>
        </div>
      </div>
      <router-link to="/chat" class="more-btn">开始聊天</router-link>
    </section>
    <footer>
      ...
      <div class="social-media">
        ...
        <a href="#"><img src="qq.png" alt="QQ"></a>
      </div>
      <div class="copyright">
        <p>© 2024 校园交友平台. 保留所有权利.</p>
      </div>
    </footer>
  </div>
</template>
